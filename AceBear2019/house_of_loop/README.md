...
So that opens us a use-after-free vulnerbility.
...
The line represent the linked-list pointer to the next note.
...
Now, we are introducing to you the **MALLOC HOOK**
